# [2.1.0-alpha.8](https://gitee.com/vi-design/color/compare/v2.1.0-alpha.7...v2.1.0-alpha.8) (2025-10-14)


### Bug Fixes

* **constant:** 将版本号常量改为字符串格式 ([7a560ef](https://gitee.com/vi-design/color/commits/7a560ef4d13a6d7169785f089ce42fa71f71761c))
* **scheme:** 调整调色板明度范围以增强色彩表现 ([a1a51a2](https://gitee.com/vi-design/color/commits/a1a51a2b1e9e792f6c81d434d0157a4d8db9c643))
* **scheme:** 调整调色板颜色值以修复视觉问题 ([b0a2a65](https://gitee.com/vi-design/color/commits/b0a2a652428ac6193cbd4bcbaa1e204af6f6ee07))
* **theme:** 修复颜色变量生成逻辑 ([b910e55](https://gitee.com/vi-design/color/commits/b910e555e8d7c4e7f47d0a28b2341354704a371d))
